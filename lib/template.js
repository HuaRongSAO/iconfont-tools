...
var wxmlTemplate = function (icon) {
    if (icon === void 0) { icon = 'tool-icon'; }
    return "\n<cover-view class=\"" + icon + " " + icon + "-{{icon}}\" style=\"width: {{ size }}rpx;height:width: {{ size }}rpx;\"></cover-view>\n";
};
exports.generateJs = function (path) { return __awaiter(_this, void 0, void 0, function () {
    var jsPath, mkJs;
...
exports.generateJson = function (path) { return __awaiter(_this, void 0, void 0, function () {
    var jsonPath, mkJs;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
...
exports.generateWxss = function (path, fileName) { return __awaiter(_this, void 0, void 0, function () {
    var from, wxssPath;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                from = sysPath.resolve(path, "../" + fileName);
...
exports.component = function (path, icon, fileName) { return __awaiter(_this, void 0, void 0, function () {
    var files;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, utils_1.default.rmdir(path)];
            case 1:
                _a.sent();
