...
var Match = /** @class */ (function () {
    function Match(prefixIcon, size) {
        if (prefixIcon === void 0) { prefixIcon = 't-icon'; }
    ...
    Match.prototype.matchesIcon = function () {
        var _a = this, content = _a.content, prefixIcon = _a.prefixIcon;
    ...
    Match.prototype.svg2DataUrl = function (svgStr) {
        svgStr = svgStr.replace(/\<svg/, "<?xml version=\"1.0\" encoding=\"utf-8\"?><svg version=\"1.1\" width='100%' height='100%' xmlns=\"http://www.w3.org/2000/svg\"");
    ...
    Match.prototype.generateSvg = function () {
        var _a = this, svg2DataUrl = _a.svg2DataUrl, icons = _a.icons;
