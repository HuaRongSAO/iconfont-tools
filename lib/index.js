...
exports.create = function (opt) { return __awaiter(_this, void 0, void 0, function () {
    var dirName, fileName, path, icon, fontSize, ex, mat, iconCtx, filePath, componentPath;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                dirName = opt.dirName, fileName = opt.fileName, path = opt.path, icon = opt.icon, fontSize = opt.fontSize;
            ...
            case 2:
                filePath = _a.sent();
                if (!opt.component) return [3 /*break*/, 4];
